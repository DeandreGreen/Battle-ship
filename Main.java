...
class Board {
  ...
  public void handleUserGuess() {
    ...
    if (row.equals(shipRow)) {
      ...
      System.out.println("You entered an invalid row and/or column, come on now, let's keep it on the boards please... row must be between a-j inclusive, columns must be between 0-9 inclusive...");
    }
...
public class Main {
  public static void main(String[] args) {
    Out o = new Out();
    o.msg("Welcome to Access Point-a-ship!");
    o.msg("I bet you can't fint my ship!!!");
    o.msg("... well, at least not in less than 40 guesses which I become invisible to you!");
    int hits = 0;
    int guesses = 0;

    Board b = new Board();
    int rowRandom = (int)(Math.random() * 4); //0 to 4
    ...
    if (guesses == 40) {
      ...
      o.msg("Maybe, just maybe yo'll try again!");
    }
    else {
      o.msg("\n\n\nYou sunk my ship!!!");
      o.msg("But that's ok, I'll figure out how to move next time... or maybe I won't...");
      o.msg("Thanks for playing Access-Point-Ship!!!!");
    }
  }
}